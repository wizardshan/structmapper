...
func (uu *UserUpdate) SetMoney(i int) *UserUpdate {
	uu.mutation.ResetMoney()
	uu.mutation.SetMoney(i)
	return uu
}

// AddMoney adds i to the "money" field.
func (uu *UserUpdate) AddMoney(i int) *UserUpdate {
	uu.mutation.AddMoney(i)
	return uu
}
...
// SetMoney sets the "money" field.
func (uuo *UserUpdateOne) SetMoney(i int) *UserUpdateOne {
	uuo.mutation.ResetMoney()
	uuo.mutation.SetMoney(i)
	return uuo
}

// AddMoney adds i to the "money" field.
func (uuo *UserUpdateOne) AddMoney(i int) *UserUpdateOne {
	uuo.mutation.AddMoney(i)
	return uuo
}
