...
func Money(v int) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func MoneyEQ(v int) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldMoney), v))
	})
}
...
func MoneyNEQ(v int) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func MoneyIn(vs ...int) predicate.User {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func MoneyNotIn(vs ...int) predicate.User {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func MoneyGT(v int) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func MoneyGTE(v int) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func MoneyLT(v int) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func MoneyLTE(v int) predicate.User {
	return predicate.User(func(s *sql.Selector) {
