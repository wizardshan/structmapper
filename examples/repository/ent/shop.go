...
func (e ShopEdges) OrdersOrErr() ([]*Order, error) {
	if e.loadedTypes[0] {
		return e.Orders, nil
	}
...
// QueryOrders queries the "orders" edge of the Shop entity.
func (s *Shop) QueryOrders() *OrderQuery {
	return (&ShopClient{config: s.config}).QueryOrders(s)
}
